...
Gestiona usuarios, agenda, datos básicos de pacientes, ventas y reportes. El rol no incluye permisos de fichas clínicas ni recetas. Si una persona administradora también vende, debe recibir adicionalmente el rol `SALES` cuando corresponda.
...
Gestiona disponibilidad, reservas, datos básicos de pacientes y ventas. Solo puede consultar de una receta la información necesaria para procesar una venta; no puede acceder a la ficha clínica completa.
