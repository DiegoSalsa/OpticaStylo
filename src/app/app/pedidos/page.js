...
export default function OrdersPage() {
  ...
  const filtered = useMemo(() => sales.filter((sale) => {
    ...
    const text = `${sale.saleNumber} ${customerLabel(sale)} ${customerRut(sale)}`.toLowerCase();
