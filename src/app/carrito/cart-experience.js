...
export default function CartExperience() {
  ...
  return <main className="cart-page"><header><p className="eyebrow">Compra en línea</p><h1>Tu carrito</h1><p>Se conserva en este dispositivo durante 30 días, aunque compres como invitado.</p></header>
